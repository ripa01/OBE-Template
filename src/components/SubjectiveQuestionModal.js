    ...
    <div className="modal-content p-4 border-2 border-black rounded-lg bg-white">
      <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
        <div className="relative transform overflow-hidden rounded-xl bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
          ...
          <h1 className="text-3xl text-primary font-bold">Create Question</h1>
        </div>
                <div className="my-4 w-full">
                  ...
                  <div id="subjectiveblock">
                    <div className="mt-2 flex justify-between items-center">
                      <label
                        ...
                        className="block text-sm mr-1 font-medium text-gray-700"
                      >
                        Name
                      </label>
                      <textarea
                  ...
                  <div id="subjectiveblock">
                    <div class="mt-2 flex justify-between items-center">
                      ...
                      >
                        <option value="SingleMCQ">P04</option>
                        <option value="MultipleMCQ">PO9</option>
                        <option value="TrueFalse">PO6</option>
                        <option value="Subjective">PO4</option>
                      </select>
                    </div>
                  </div>
                  <div id="subjectiveblock">
                    <div class="mt-2 flex justify-between items-center">
                      ...
                      <select
                        ...
                        class="shadow-sm pr-4 p-2 w-72 focus:ring-blue-500 border border-gray-300 focus:border-blue-500 block w-full sm:text-sm border-gray-300 rounded-md"
                      >
                        <option value="SingleMCQ">CO1</option>
                        <option value="MultipleMCQ">CO2</option>
                        <option value="TrueFalse">C03</option>
                        <option value="Subjective">CO4</option>
                      </select>
                    </div>
                  </div>
                  <div id="subjectiveblock">
