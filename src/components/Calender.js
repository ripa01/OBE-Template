      ...
      <div className="hidden w-full lg:grid lg:grid-cols-7 lg:grid-rows-6 lg:gap-px">
          ...
          <ol className="mt-2">
            <li>
              <a href="/" className="group flex">
                <p className="flex-auto truncate font-medium text-gray-900 group-hover:text-indigo-600">Summer vacation</p>
            ...
            <li>
              <a href="/" className="group flex">
                <p className="flex-auto truncate font-medium text-gray-900 group-hover:text-indigo-600">Advisor meeting</p>
        ...
        <div className="relative bg-white px-3 py-2">
          ...
          <ol className="mt-2">
            <li>
              <a href="/" className="group flex">
                <p className="flex-auto truncate font-medium text-gray-900 group-hover:text-indigo-600">Result day</p>
        ...
        <div className="relative bg-white px-3 py-2">
          ...
          <ol className="mt-2">
            <li>
              <a href="/" className="group flex">
                <p className="flex-auto truncate font-medium text-gray-900 group-hover:text-indigo-600">Preparatory Leave</p>
        ...
        <div className="relative bg-white px-3 py-2">
          ...
          <ol className="mt-2">
            <li>
              <a href="/" className="group flex">
                <p className="flex-auto truncate font-medium text-gray-900 group-hover:text-indigo-600">Semester Break</p>
            ...
            <li>
              <a href="/" className="group flex">
                <p className="flex-auto truncate font-medium text-gray-900 group-hover:text-indigo-600">Mid Exam</p>
